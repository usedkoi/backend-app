package ajou.usedkoi.backend.persistence.repository;

import ajou.usedkoi.backend.persistence.entity.RegionEntity;
...
//RegionEntity와 연결된 테이블에 CRUD 작업을 수행할 수 있는 기본 메서드를 구현한
//인스턴스를 자동으로 생성
@Repository
